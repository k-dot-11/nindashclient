...
import { FaDownload, FaInfoCircle, FaPizzaSlice } from "react-icons/fa";
            ...
            axios
                ...
                .then((res) => {
                    if (res.status == 200) {
                        ...
                        setTotalEnergy(
                            totalEnergy + res.data.enerc * (q / 100)
                        );
                        setTotalD3(
                            totalD3 + res.data.chocal * 1000000 * (q / 100)
                        );
                        ...
                        setTotalIron(
                            totalIron + res.data.fe * 1000 * (q / 100)
                        );
        ...
        <Flex justify="center" direction="column" align="center" m={2}>
                ...
                <Table variant="striped">
                    ...
                    <Tfoot>
                        ...
                        <Tr>
                            ...
                            <Th fontSize="sm" textAlign="center" isNumeric>
                                {roundNumber(
                                    100 * (roundNumber(totalFat) / totalWeight)
                                ) || 0}{" "}
                            </Th>
                            <Th fontSize="sm" textAlign="center" isNumeric>
                                {roundNumber(
                                    100 *
                                        (roundNumber(totalEnergy) / totalWeight)
                                ) || 0}
                            </Th>
                            <Th fontSize="sm" textAlign="center" isNumeric>
                                {roundNumber(
                                    100 * (roundNumber(totalProt) / totalWeight)
                                ) || 0}
                            </Th>
                            <Th fontSize="sm" textAlign="center" isNumeric>
                                {roundNumber(
                                    100 * (roundNumber(totalCarb) / totalWeight)
                                ) || 0}
                            </Th>
                            <Th fontSize="sm" textAlign="center" isNumeric>
                                {roundNumber(
                                    100 * (roundNumber(totalIron) / totalWeight)
                                ) || 0}
                            </Th>
                            <Th fontSize="sm" textAlign="center" isNumeric>
                                {roundNumber(
                                    100 * (roundNumber(totalD3) / totalWeight)
                                ) || 0}
                            </Th>
                            <Th fontSize="sm" textAlign="center" isNumeric>
                                {roundNumber(
                                    100 * (roundNumber(totalA) / totalWeight)
                                ) || 0}
                            </Th>
                        </Tr>
                    </Tfoot>
            ...
            {items.length > 0 && (
                <Flex>
                    ...
                    {excelData.length > 0 && (
                        <Button rightIcon={<FaDownload />} variant={'solid'} ml={3} colorScheme='teal'>
